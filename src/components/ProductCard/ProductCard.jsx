...
const ProductCard = (props) => {
  ...
  return (
    <div onClick={props.handleAddToCart} className='productCard-container'>
      <Link to={`/productos/${props.productId}`} id={props.productId} className='productCard-image links'>
      ...
      <div className='productCard-text_container'>
        ...
        <button className={inCart ? 'productCard-addButton inCart' : 'productCard-addButton'} onClick={props.handleAddCart}>
          <span>
